...
public class PaymentFocusDashboard {
    ...
    public PaymentFocusDashboard(String staffName, int yourPaymentsSunday, int yourPlusLifePaymentsSunday, int totalPaymentsSunday, double passPercentageFinalSunday, int yourPaymentsFinal, int yourPlusLifePaymentsFinal, int totalPaymentsFinal, double passPercentageFinal) {
