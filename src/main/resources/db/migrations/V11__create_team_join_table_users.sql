...
(
    ...
    CONSTRAINT fk_user_on_team FOREIGN KEY (users_id) REFERENCES participants (id),
...
(
    ...
    CONSTRAINT fk_masterlife_on_team FOREIGN KEY (masterlife_id) REFERENCES participants (id),
