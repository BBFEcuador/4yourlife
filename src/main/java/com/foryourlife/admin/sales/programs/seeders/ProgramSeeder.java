...
public class ProgramSeeder {
    ...
    CommandLineRunner initPrograms() {
        return args -> {
            ...
            Product product = Product.create("1a9f5420-a08d-4b66-99ed-616a7a50864a", "Focus + Your", "elweso-code", 700.5, "DOLAR", true, "Focus + Your", null, List.of(programs.get(0), programs.get(1)), Campus.create("61d88b2a-a22e-4cb0-8e43-e036483039d6", "Ecuador", "Quito", "De los Cedros OE1-13 y Real Audiencia", "094456123"),"bala-id");
