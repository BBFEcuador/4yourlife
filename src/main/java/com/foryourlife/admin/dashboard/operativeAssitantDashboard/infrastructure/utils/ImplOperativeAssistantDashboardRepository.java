...
import com.foryourlife.admin.dashboard.operativeAssitantDashboard.domain.life.CallTypeStats;
import com.foryourlife.admin.dashboard.operativeAssitantDashboard.domain.life.CallsInfo;
...
@Service
public class ImplOperativeAssistantDashboardRepository  {
    private final CallRepository callRepository;

    public ImplOperativeAssistantDashboardRepository(CallRepository callRepository) {
