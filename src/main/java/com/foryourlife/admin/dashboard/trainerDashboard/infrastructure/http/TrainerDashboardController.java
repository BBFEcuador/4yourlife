package com.foryourlife.admin.dashboard.trainerDashboard.infrastructure.http;

import com.foryourlife.admin.dashboard.trainerDashboard.application.TrainerViewQueryService;
