package com.foryourlife.programs.seeders;
    ...
    CommandLineRunner initPrograms(){
        return args -> {
            List<Program> programs = Arrays.asList(
                    Program.create("55c3da1c-b516-4a55-9fdd-21317ee6e4c0","Focus",1),
                    Program.create("bff32809-d719-4dfd-90b0-6f7a0f63e2fe","Your",2),
                    Program.create("3024c8f1-d603-47fc-8369-0e90cd2e703e","Life",3)
            );
