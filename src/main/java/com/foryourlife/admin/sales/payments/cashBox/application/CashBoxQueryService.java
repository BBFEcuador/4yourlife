...
public class CashBoxQueryService {
    ...
    public List<CashBox> getCashBoxNotOpened() {
        return repository.findAll().stream()
                .filter(cashBox -> cashBox.cashDrawer.isEmpty() ||
                        cashBox.cashDrawer.stream().noneMatch(cashDrawer -> cashDrawer.getStatus() == CashDrawerStatus.OPEN))
