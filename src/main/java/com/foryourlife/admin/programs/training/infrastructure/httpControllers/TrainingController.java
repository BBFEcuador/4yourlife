    ...
    public ResponseEntity<?> getAllCalendarEvent() {
        ...
        trainings.forEach(training -> {
            ...
            trainingResponse.add(
                    new TrainingResponse(training.getId(),
                            name,
                            training.getStartDate(),
                            training.getEndDate().atTime(23, 59),
                            false,
                            color,
                            new TrainingResponse.ExtendedProps("Epic description", "Nice location", new String[]{"clave", "valor"}),
                            training
                    )
            );
        });
